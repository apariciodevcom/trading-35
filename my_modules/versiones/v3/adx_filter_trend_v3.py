"""
===========================================================================
 Estrategia: ADX Filter Trend (v3 extendida y parametrizable) - LeanTech Trading
===========================================================================
...
Novedades v3:
-------------
✅ Umbral ADX parametrizable (default=20)
...
def generar_senales(df: pd.DataFrame, adx_threshold: float = 20, debug: bool = False) -> pd.DataFrame:
    try:
        df = df.copy()
